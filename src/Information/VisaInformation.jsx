      ...
      <div className="max-w-7xl mx-auto grid gap-8">
        ...
        <div className="bg-white rounded-3xl shadow-lg p-6 sm:p-8 border border-gray-200">
          ...
          <ul className="space-y-4 text-gray-700 text-sm sm:text-base leading-7">
            <li>
              • A valid passport and one passport-size photo with a light
              background are required.
            </li>

            <li>
              • Visa fees can be paid only in convertible currencies such as
              Euro, Swiss Franc, Pound Sterling, US Dollar, Australian Dollar,
              Canadian Dollar, Hong Kong Dollar, Singapore Dollar, and Japanese
              Yen.
            </li>

            <li>
              • Credit cards, Indian currency, and Nepalese currency are not
              accepted for visa payment.
            </li>
          </ul>
        </div>

        {/* Tourist Visa Table */}
        <div className="bg-white rounded-3xl shadow-lg p-6 sm:p-8 border border-gray-200 overflow-x-auto">
          ...
          <table className="w-full border-collapse min-w-[500px]">
            <thead>
              <tr className="bg-red-900 text-white">
                <th className="p-4 text-left">Visa Facility</th>
            ...
            <tbody>
              <tr className="border-b">
                <td className="p-4">Multiple Entry</td>
                <td className="p-4">15 Days</td>
                <td className="p-4">US $30</td>
              </tr>

              <tr className="border-b bg-gray-50">
                <td className="p-4">Multiple Entry</td>
                <td className="p-4">30 Days</td>
                <td className="p-4">US $50</td>
              </tr>

              <tr>
                <td className="p-4">Multiple Entry</td>
                <td className="p-4">90 Days</td>
                <td className="p-4">US $125</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-lg p-6 sm:p-8 border border-gray-200">
          ...
          <div className="grid sm:grid-cols-2 gap-4 text-gray-700 text-sm sm:text-base">
            ...
            <div className="bg-gray-50 p-4 rounded-xl sm:col-span-2">
              7. ID Card issued by Sub-divisional Magistrate or higher-ranking
              officials
            </div>
          </div>
        </div>
        ...
        {/* Visa Extension */}
        <div className="bg-red-900 text-white rounded-3xl shadow-xl p-6 sm:p-8">
