...
const UpperMustang = () => {
  ...
  const treks = [
...

    {
      ...
      image: "https://media.sublimetrails.com/uploads/img/lo-manthang-(2).webp",
      ...
      <div className="min-h-screen bg-gray-50 py-20 px-6">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-500 mt-4 max-w-2xl mx-auto">
            Explore the hidden desert kingdom of Nepal filled with ancient
            caves, monasteries, and Tibetan culture.
          </p>
        </div>
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between mt-6">
                  ...
                  <button className="bg-red-900 hover:bg-red-800 text-white px-5 py-2 rounded-xl transition">
                    Book now
                  </button>
                </div>
