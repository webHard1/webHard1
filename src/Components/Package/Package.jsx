    ...
    return (
        <div className="min-h-screen flex flex-">
            ...
            <div className="pt-24 px-6 flex-1">
                ...
                {/* Slider Container */}
                <div className="relative gap-10   max-w-7xl shadow-lg   mx-auto overflow-hidden">
                    ...
                    >
                        ...
                        {packages.map((pkg) => (
                            <div
                                key={pkg.id}
                                className="min-w-full  hover:scale-120 sm:min-w-[48%] lg:min-w-[31%] bg-white rounded-2xl shadow-lg overflow-hidden"
                            >
